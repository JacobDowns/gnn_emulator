...
class NodeBlock(nn.Module):
    ...
    def __init__(self, custom_func=None, hidden_size=64, K=10):

        super(NodeBlock, self).__init__()

        self.net = custom_func
        self.cheb = ChebConv(in_channels=hidden_size, out_channels=hidden_size, K=K)
    ...
    def forward(self, graph):
        ...
        x_node_ = self.cheb(x=x_node_, edge_index=edges.T)
...
class GnBlock(nn.Module):
    ...
    def __init__(self, hidden_size=32):
        ...
        self.nb_module = NodeBlock(custom_func=nb_custom_func, hidden_size=hidden_size, K=10)
